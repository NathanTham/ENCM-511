...
uint16_t ADC(void) 
{
    ...
    AD1CON2bits.SMPI = 0b0001;    //Interrupts at the completion of conversion for each sample/convert sequence
    ...
    AD1CON3bits.ADCS = 0b00000;   //A->D conversion clock select bits     CHOOSE THIS VALUE
